		...
		const disposeRoute = ctx.get("webServer").register({
			...
			handler: async (req, res) => {
				...
				if (pathname.startsWith("/api/")) {
					...
					try {
						if (pathname === "/api/servers") json(200, await handlers.get("mcp/list-servers")({}));
						else if (pathname === "/api/servers/add") json(200, await handlers.get("mcp/add-server")(body));
						else if (pathname === "/api/servers/remove") json(200, await handlers.get("mcp/remove-server")(body));
						else if (pathname === "/api/servers/toggle") json(200, await handlers.get("mcp/toggle-server")(body));
						else if (pathname === "/api/servers/restart") json(200, await handlers.get("mcp/restart-server")(body));
						else if (pathname === "/api/logs") json(200, await handlers.get("mcp/get-logs")({}));
